      ...
      <div className="bg-white rounded-2xl border border-gray-100/60 shadow-sm p-5 mb-4">
        ...
        <div className="relative flex items-center justify-end pt-3">
          ...
          <button
            ...
            className="ml-2 w-5 h-5 rounded-full text-gray-600 hover:bg-gray-200 transition-colors flex items-center justify-center"
          >
          ...
          {modeTooltipOpen && (
            <div className="absolute right-0 bottom-full mb-2 w-64 bg-gray-800 text-white text-xs rounded-lg p-3 shadow-lg z-40">
              ...
              <div className="absolute right-2 top-full w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-800" />
            </div>
          )}
        </div>
